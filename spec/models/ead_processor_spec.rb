...
RSpec.describe EadProcessor, clean: true do
  ...
  context 'eads and html for downloads' do
    after do
      FileUtils.rm_rf(Dir["#{Rails.root}/public/ead/InU-Li-VAD6017.xml"])
      FileUtils.rm_rf(Dir["#{Rails.root}/public/html/InU-Li-VAD6017.html"])
    end
    
    it 'can copy ead to public directory' do
      ead = Rails.root.join('spec', 'fixtures', 'ead', 'lilly', 'InU-Li-VAD6017.xml')
      public_ead = Rails.root.join('public', 'ead', 'InU-Li-VAD6017.xml')
    ...
    it 'can transform an ead to html and place it in public directory' do
      html = Rails.root.join('public', 'html', 'InU-Li-VAD6017.html')
      ead = Rails.root.join('spec', 'fixtures', 'ead', 'lilly', 'InU-Li-VAD6017.xml')
